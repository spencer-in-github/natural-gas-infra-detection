...
5. created label json data for object detection and csv labels for binary classification
6. added places without well (satellite images and labels) into the trainset
