    ...
    try:
        ...
        if response.status_code == 401:
            ...
            try:
                ...
                headers_request["Authorization"] = f"Bearer {oauth.token['access_token']}"
...
def main(download_folder="downloads"):
    ...
    for index, row in coordinates_df.head(500).iterrows():
    ...
    random_coords = generate_random_coordinates_outside_bbox(500,        # TODO: change here to select the number of non-well train data
                                                             # len(coordinates_df),
